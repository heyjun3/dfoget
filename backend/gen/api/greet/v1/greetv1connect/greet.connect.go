...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/heyjun3/dforget/backend/gen/api/greet/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	GreetServiceGreetProcedure = "/api.greet.v1.GreetService/Greet"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	greetServiceServiceDescriptor     = v1.File_api_greet_v1_greet_proto.Services().ByName("GreetService")
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/api.greet.v1.GreetService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.greet.v1.GreetService.Greet is not implemented"))
}
